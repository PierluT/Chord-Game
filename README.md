...
Each jump you can do, you get some points and you increment your score. In the first level you get +50 point for each jump, in the second +100 and in the third +150. Additionally you can get a bonus with a moltiplicator that increments until 5, whenever the player plays 5 chords without errors.  
